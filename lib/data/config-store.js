    ...
    _onDispatch(payload) {
        switch (payload.type) {
            ...
            case 'SET_RUN_COMMAND':
                this.runCommand = template(payload.runCommand);
                this._changes.add('runCommand');
                break;
            case 'SET_SKIP_COMPILATION':
                this.skipCompilation = payload.skipCompilation;
                this._changes.add('skipCompilation');
                break;
