...
// props: problemId, examples, enableChecking, caseInsensitive, ignoreWhitespace, acceptNumericError
// state: collapsed
export default class ExamplesSection extends React.PureComponent {
    ...
    render() {
        ...
        return <CollapsableSubsection collapsed={this.state.collapsed} toggleCollapsed={this.toggleCollapsed}
                heading={<span><span style={{marginRight: '1em'}}>Examples</span>
                {companion} {producedStderr && <span className="badge badge-warning">wrote to stderr</span>}</span>}>
