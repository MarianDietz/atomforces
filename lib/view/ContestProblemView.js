...
export default class ContestProblemView extends React.Component {
    ...
    render() {
        return <div>
            <ContestContainer contestId={this.props.contestId} refreshClicked={this.refresh} prepareDirectory={this.prepareDirectory} isSubmitting={this.state.isSubmitting} />
