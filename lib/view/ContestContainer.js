...
class ContestContainer extends React.PureComponent {
    ...
    render() {
        ...
        return <ContestView contest={this.props.data} refreshClicked={this.props.refreshClicked} prepareDirectory={this.props.prepareDirectory} isSubmitting={this.props.isSubmitting} />
    }
