...
export default class CompilationSection extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        // Un-collapse if there is output and not success
        if (this.state.collapsed && prevState.collapsed && this.props.compilation.output &&
            this.props.compilation.output.length > 0 && !this.props.compilation.outdated &&
            this.props.compilation.exitCode != null && this.props.compilation.exitCode !== 0) {
