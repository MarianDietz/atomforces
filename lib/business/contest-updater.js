...
import { updateLogin, updateContest, setProblems, setSubmissions, updateProblem } from '../data/atomforces-actions';
...
export default class ContestUpdater {
    ...
    refreshStandings(){
      ...
      if(!handle) return
      return CodeforcesScraper.getUserRank(contest.codeforcesId, handle).then(rank => {
        updateLogin({"standing": rank})
